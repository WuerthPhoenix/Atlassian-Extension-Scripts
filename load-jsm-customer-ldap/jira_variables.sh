...
tmpdirldpap="$( jq -r ' .ldap.tmpdirldpap ' "$config_file" )"
ldaphost="$( jq -r ' .ldap.ldaphost ' "$config_file" )"
ldapbase="$( jq -r ' .ldap.ldapbase ' "$config_file" )"
ldapbind="$( jq -r ' .ldap.ldapbind ' "$config_file" )"

ldappwd="$( jq -r ' .ldap.ldappwd ' "$config_file" )"
ldappwd=$(cat $ldappwd |  sed 's/\"//g' )

ldapfilter="$( jq -r ' .ldap.ldapfilter ' "$config_file" )"
ldapfields="$( jq -r ' .ldap.ldapfields ' "$config_file" )"
